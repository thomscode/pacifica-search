...
namespace Drupal\pacifica_migration\Plugin\migrate\process;
 ...
 *       source: author
 *     -
 *       plugin: instrument_category
 *       source: instrument_display_name
 * @endcode
 *
 ...
 * )
 */
class InstrumentCategory extends ProcessPluginBase {
